...
public class DeliveryPageLocator {
	static final String deliveryPageTitle = "//h4[text()='Get your order']";
	static final String fromACollectionPoint = "//p[text()='Collect your order from a convenient location']";
